...
<head>
    ...
    <link rel="stylesheet" href="jansaharanew/assets/css/vendor/vendor.min.css">
    <link rel="stylesheet" href="jansaharanew/assets/css/plugins/plugins.min.css">
    ...
    <div class="header-area header-area--default">
        ...
        <div class="header-top-wrap border-bottom">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <p class="text-center top-message">Fast, Reliable Ambulance Services – Anytime, Anywhere</p>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-lg-12">
                        <div class="header default-menu-style position-relative">
                            ...
                            <div class="header__logo">
                                <a href="jansaharanew/index.html">
                                    <img src="jansaharanew/assets/images/jan-sahara-ambulance.webp" aria-label="Mitech Logo" width="250" height="" class="img-fluid" alt="">
                                </a>
                            </div>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="section-title-wrap text-center">
                                ...
                                <h3 class="heading">Comprehensive Care, <span class="text-color-primary">Anytime, Anywhere</span></h3>
                            </div>
                            <!-- section-title-wrap Start -->
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-6 wow move-up">
                                        ...
                                        <div class="ht-box-images style-01">
                                            <div class="image-box-wrap">
                                                <div class="box-image">
                                                    <a href="https://jansaharaambulance.com/road-ambulance-service.php"><img class="img-fulid" src="jansaharanew/assets/images/Road-ambulance-mumbai.webp" alt="Private ambulance mumbai"></a>
                                                </div>
                                                <div class="content">
                                                    <h5 class="heading"><a href="https://jansaharaambulance.com/road-ambulance-service.php">Road Ambulance</a></h5>
                                                    <div class="text">Swift and reliable road ambulance services with advanced medical support, ensuring timely emergency care and safe patient transportation 24/7.
                                                    </div>
                                                    <div class="circle-arrow">
                                                        <div class="middle-dot"></div>
                                                        <div class="middle-dot dot-2"></div>
                                                        <a href="https://jansaharaambulance.com/road-ambulance-service.php">
                                    ...
                                    <div class="col-lg-4 col-md-6 wow move-up">
                                        ...
                                        <div class="ht-box-images style-01">
                                            <div class="image-box-wrap">
                                                <div class="box-image">
                                                    <a href="https://jansaharaambulance.com/train-ambulance-service.php"><img class="img-fulid" src="jansaharanew/assets/images/train-ambulance.webp" alt="Train ambulance mumbai"></a>
                                                </div>
                                                <div class="content">
                                                    <h5 class="heading"><a href="#">Train Ambulance</a></h5>
                                                    <div class="text">Affordable and efficient train ambulance services for long-distance patient transport, offering expert medical care throughout the journey.
                                                    </div>
                                                    <div class="circle-arrow">
                                                        <div class="middle-dot"></div>
                                                        <div class="middle-dot dot-2"></div>
                                    ...
                                    <div class="col-lg-4 col-md-6 wow move-up">
                                        ...
                                        <div class="ht-box-images style-01">
                                            <div class="image-box-wrap">
                                                <div class="box-image">
                                                    <a href="https://jansaharaambulance.com/air-ambulance-service.php"><img class="img-fulid" src="jansaharanew/assets/images/air-ambulance.webp" alt="Air ambulance mumbai"></a>
                                                </div>
                                                <div class="content">
                                                    <h5 class="heading"><a href="https://jansaharaambulance.com/air-ambulance-service.php">Air Ambulance</a></h5>
                                                    <div class="text">Rapid and dependable air ambulance services with cutting-edge medical facilities, ensuring urgent patient transfer during critical emergencies.
                                                    </div>
                                                    <div class="circle-arrow">
                                                        <div class="middle-dot"></div>
                                                        <div class="middle-dot dot-2"></div>
                                                        <a href="https://jansaharaambulance.com/air-ambulance-service.ph">
                                                            <i class="fas fa-arrow-right"></i>
                                                        </a>
                                                    </div>
                                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-md-12 wow move-up">
                                        ...
                                        <div class="ht-box-images style-01">
                                            <div class="image-box-wrap">
                                                <div class="box-image">
                                                    <a href="https://jansaharaambulance.com/antim-sanskar-seva.php"><img src="jansaharanew/assets/images/funeral-company-mumbai.webp" alt="Funeral service provider in mumbai" class="img-fluid"></a>
                                                </div>
                                                <div class="content">
                                                    <h5 class="heading"><a href="https://jansaharaambulance.com/antim-sanskar-seva.php">Funeral Services / Antim Sanskar Seva</a></h5>
                                                    <div class="text">Compassionate and dignified funeral services, including Antim Sanskar Seva, to support you in honoring your loved ones with care and respect.
                                                    </div>
                                                    <div class="circle-arrow">
                                                        <div class="middle-dot"></div>
                                                        <div class="middle-dot dot-2"></div>
                                                        <a href="https://jansaharaambulance.com/antim-sanskar-seva.php">
                                                            <i class="fas fa-arrow-right"></i>
                                                        </a>
                                                    </div>
                                                </div>
                            ...
                            <div class="section-under-heading text-center section-space--mt_60 section-space--pt_30">Need Assistance? <a href="#">Contact Us</a> Now for Prompt and Compassionate Support!</div>
                        ...
                        <div class="row">
                            <div class="col-lg-5">
                                <div class="section-title small-mb__40 tablet-mb__40">
                                    ...
                                    <h3 class="heading">Jan Sahara - Trusted<span class="text-color-primary"> Ambulance Service &amp; Funeral Service in Mumbai</span></h3>
                                    <p class="text mt-20">At Jan Sahara Ambulance Services, we provide fast, reliable, and compassionate care when it matters most. Serving Mumbai with excellence, we specialize in road, train, and air ambulance services, along with Antim Sanskar Seva, funeral arrangements, and hearse van services. Whether it’s a medical emergency or dignified funeral support, our dedicated team is here 24/7 to ensure seamless assistance.</p>

                                    <div class="sider-title-button-box mt-30">
                                        <a href="https://jansaharaambulance.com/about.php" class="ht-btn ht-btn-md">Read more</a>
                                    </div>
                                        ...
                                        <a class="link" href="#">
                                            <div class="list-header">
                                                ...
                                                <div class="title-wrap">
                                                    <h6 class="title">Always Here, Always Ready – 24/7 Support </h6>
                                                </div>
                                            </div>
                                        </a>
                                    </div>
                                    <div class="list-item">
                                        <a class="link" href="#">
                                            <div class="list-header">
                                                ...
                                                <div class="title-wrap">
                                                    <h6 class="title">Care with Compassion, When It Matters Most </h6>
                                                </div>
                                            </div>
                                        </a>
                                    </div>
                                    <div class="list-item">
                                        <a class="link" href="#">
                                            <div class="list-header">
                                                ...
                                                <div class="title-wrap">
                                                    <h6 class="title"> Trusted Experts for Life’s Critical Moments </h6>
                                                </div>
                                            </div>
                                        </a>
                                    </div>
                                    ...
                                    <div class="list-item">
                                        <a class="link" href="#">
                                            <div class="list-header">
                                                ...
                                                <div class="title-wrap">
                                                    <h6 class="title"> Swift, Reliable, and Always Caring </h6>
                                                </div>
                                            </div>
                                        </a>
                                    </div>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="projects-wrap swiper-container projects-slider__container">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <!-- Projects Wrap Start -->
                                        <a href="https://jansaharaambulance.com/road-ambulance-service.php" class="projects-wrap style-01 wow move-up">
                                            <div class="projects-image-box">
                                                <div class="projects-image">
                                                    <img class="img-fluid" src="jansaharanew/assets/images/road-ambulance.webp" alt="">
                                                </div>
                                                <div class="content">
                                    ...
                                    <div class="swiper-slide">
                                        <!-- Projects Wrap Start -->
                                        <a href="https://jansaharaambulance.com/train-ambulance-service.php" class="projects-wrap style-01 wow move-up">
                                            <div class="projects-image-box">
                                                <div class="projects-image">
                                                    <img class="img-fluid" src="jansaharanew/assets/images/train-ambulance-mumbai.webp" alt="">
                                                </div>
                                                <div class="content">
                                    ...
                                    <div class="swiper-slide">
                                        ...
                                        <a href="https://jansaharaambulance.com/air-ambulance-service.php" class="projects-wrap style-01 wow move-up">
                                            <div class="projects-image-box">
                                                <div class="projects-image">
                                                    <img class="img-fluid" src="jansaharanew/assets/images/air-ambulance-mumbai.webp" alt="">
                                                </div>
                                                <div class="content">
                                    ...
                                    <div class="swiper-slide">
                                        ...
                                        <a href="https://jansaharaambulance.com/cardiac-ambulance-service.php" class="projects-wrap style-01 wow move-up">
                                            <div class="projects-image-box">
                                                <div class="projects-image">
                                                    <img class="img-fluid" src="jansaharanew/assets/images/cardiac-ambulance-mumbai.webp" alt="">
                                                </div>
                                                <div class="content">
                                    ...
                                    <div class="swiper-slide">
                                        ...
                                        <a href="https://jansaharaambulance.com/event-ambulance-service.php" class="projects-wrap style-01 wow move-up">
                                            <div class="projects-image-box">
                                                <div class="projects-image">
                                                    <img class="img-fluid" src="jansaharanew/assets/images/ambulance-for-events.webp" alt="">
                                                </div>
                                                <div class="content">
                                    ...
                                    <div class="swiper-slide">
                                        ...
                                        <a href="https://jansaharaambulance.com/emergency-ambulance-service.php" class="projects-wrap style-01 wow move-up">
                                            <div class="projects-image-box">
                                                <div class="projects-image">
                                                    <img class="img-fluid" src="jansaharanew/assets/images/Ambulance-Service-for-Emergency.webp" alt="">
                                                </div>
                                                <div class="content">
                                    ...
                                    <div class="swiper-slide">
                                        ...
                                        <a href="https://jansaharaambulance.com/dead-body-ambulance-service.php" class="projects-wrap style-01 wow move-up">
                                            <div class="projects-image-box">
                                                <div class="projects-image">
                                                    <img class="img-fluid" src="jansaharanew/assets/images/Dead-Body-Ambulance-Service.webp" alt="">
                                                </div>
                                                <div class="content">
                                    ...
                                    <div class="swiper-slide">
                                        ...
                                        <a href="https://jansaharaambulance.com/outstation-ambulance-service.php" class="projects-wrap style-01 wow move-up">
                                            <div class="projects-image-box">
                                                <div class="projects-image">
                                                    <img class="img-fluid" src="jansaharanew/assets/images/outstation-ambulance-service.webp" alt="">
                                                </div>
                                                <div class="content">
                                    ...
                                    <div class="swiper-slide">
                                        ...
                                        <a href="https://jansaharaambulance.com/dead-body-ambulance-service.php" class="projects-wrap style-01 wow move-up">
                                            <div class="projects-image-box">
                                                <div class="projects-image">
                                                    <img class="img-fluid" src="jansaharanew/assets/images/antim-sanskar-seva.webp" alt="">
                                                </div>
                                                <div class="content">
                            ...
                            <div class="section-under-heading text-center section-space--mt_40">Need Help Now? We’re Always Here for You – Call Anytime! <a href="tel:9820700800">9820 700800</a> / <a href="tel:9320800900">9320 800900</a></div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="section-title-wrap text-center section-space--mb_60">
                                ...
                                <h3 class="heading">Stories of <span class="text-color-primary"> Trust and Compassion</span></h3>
                            </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-6 col-lg-6">
                            <div class="conact-us-wrap-one">
                                <h3 class="heading"><span class="text-color-primary">Facing an Emergency?</span> We’re Here 24/7 to Provide Fast and Compassionate Care When You Need It Most!</h3>

                                <div class="sub-heading">Prompt, Professional Assistance Whenever You Need It Most.</div>
                        ...
                        <div class="col-lg-6 col-lg-6">
                            <div class="contact-info-one text-center">
                                ...
                                <h2 class="call-us"><a href="tel:9820700800">9820 700800</a></h2><br>

                                <h2 class="call-us"><a href="tel:9820700900">9320 800900</a></h2>
                                <div class="contact-us-button mt-20">
                                    <a href="https://jansaharaambulance.com/contact-us.php" class="btn btn--secondary">Contact us</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row footer-widget-wrapper">
                        <div class="col-lg-3 col-md-6 col-sm-6 footer-widget">
                            <div class="footer-widget__logo mb-30">
                                <img src="jansaharanew/assets/images/jan-sahara-ambulance.webp" width="280" height="48" class="img-fluid" alt="">
                            </div>
                            <ul class="footer-widget__list">
                                <li><a href="https://www.google.com/maps/place/Juhu+Azad+Nagar+S.+R.+A.+Co-Op+Society/@19.1135549,72.8373675,17z/data=!3m1!4b1!4m5!3m4!1s0x3be7c9c57dad7191:0x3f2963187d5619c4!8m2!3d19.1135549!4d72.8395562" target="_blank">613, Juhu Azad Nagar, S.R. A. Co-Op-Soc, C.D. Barfiwala Road, Andheri West, Mumbai - 400058</a></li>
                        ...
                        <div class="col-lg-2 col-md-4 col-sm-6 footer-widget">
                            ...
                            <ul class="footer-widget__list">
                                <li><a href="https://jansaharaambulance.com/road-ambulance-service.php" class="hover-style-link">Road Ambulance</a></li>
                                <li><a href="https://jansaharaambulance.com/train-ambulance-service.php" class="hover-style-link">Train Ambulance</a></li>
                                <li><a href="https://jansaharaambulance.com/air-ambulance-service.php" class="hover-style-link">Air Ambulance</a></li>
                        ...
                        <!--<div class="col-lg-2 col-md-4 col-sm-6 footer-widget">
                            ...
                            <ul class="footer-widget__list">
                                <li><a href="https://jansaharaambulance.com/" class="hover-style-link">Home</a></li>
                                <li><a href="https://jansaharaambulance.com/about.php" class="hover-style-link">About us</a></li>
                                <li><a href="https://jansaharaambulance.com/book-ambulance.php" class="hover-style-link">Book Ambulance</a></li>
                                <li><a href="https://jansaharaambulance.com/pay-online.php" class="hover-style-link">Pay Online</a></li>
                                <li><a href="https://jansaharaambulance.com/contact-us.php" class="hover-style-link">Contact us</a></li>
                                <li><a href="https://drive.google.com/file/d/1ODJFFQRkWyKZunS3USPfDbRA7z7xziK6/view?pli=1" target="_blank" class="hover-style-link">Download Catalog</a></li>
                            </ul>
                        </div>-->
                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-md-7 text-center text-md-start">
                            <span class="copyright-text">&copy; 2025 Jansahara Ambulance. <a href="https://hasthemes.com/">All Rights Reserved.</a></span>
                        </div>
                ...
                <div class="container-fluid">
                    <div class="row align-items-center">
                        <div class="col-md-6 col-8">
                            ...
                            <div class="logo">
                                <a href="jansaharanew/index.html">
                                    <img src="jansaharanew/assets/images/jan-sahara-ambulance.webp" class="img-fluid" alt="Jan Sahara Ambulance">
                                </a>
                            </div>
                        </div>
...
<div class="footer-strip">
    ...
    <!-- Bootstrap JS -->
    <script src="jansaharanew/assets/js/vendor/bootstrap.min.js"></script>

    <!-- Plugins JS (Please remove the comment from below plugins.min.js for better website load performance and remove plugin js files from avobe) -->

    <script src="jansaharanew/assets/js/plugins/plugins.min.js"></script>
